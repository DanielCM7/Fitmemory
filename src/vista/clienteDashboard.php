...
/>
  ...
  <body class="app-body d-flex py-4 bg-body-tertiary">
    <main class="app-main app-main-sesion form-signin w-100 mx-auto">
      <?php cabeceraWeb(); ?>

        <p class="bienvenida"> Hola <?php echo $_SESSION['nombre']?>, ¡Bienvenido a Fitmemory!</p>
      <div class="container text-center panel-dashboard">
